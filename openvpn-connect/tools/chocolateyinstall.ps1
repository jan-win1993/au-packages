...
$downloadArgs = @{
  ...
  url             = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.8.0.4528_signed_x86.msi'
  checksum        = '51a1ea600eb094f59320503ce2a9a34e849a8241507435eba3c53da84f5c6f27'
  checksumType    = 'sha256'
  url64bit        = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.8.0.4528_signed.msi'
  checksum64      = 'cc741664d07fd4eedc98103edb86b791d290640a969c288c3d1cb2d0b6de98ce'
