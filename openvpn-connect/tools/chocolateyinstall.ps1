...
$downloadArgs = @{
  ...
  checksum        = 'c4cedee5eebc3c7d329b1efd071ac544feac50e4e4e94d9755f171cbd8b6d4d9'
  checksumType    = 'sha256'
  url64bit        = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.4.0.3121_signed.msi'
  checksum64      = 'c001c26f0141d66409f91aca069b402f73913556ecc39156d0522922216809d7'
