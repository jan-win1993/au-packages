...
$downloadArgs = @{
  ...
  url             = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.4.1.3150_signed_x86.msi'
  checksum        = 'a375d863170148ab0f1bc0984b8ad8aa4d916e62a7cbfc60139a7722250ab126'
  checksumType    = 'sha256'
  url64bit        = 'https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.4.1.3150_signed.msi'
  checksum64      = '6fe433570331c96bd9b2ae06a25742e9f09f8316a3531b3d562a7f37a0c70f96'
